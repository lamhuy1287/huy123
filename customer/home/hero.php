...
if(isset($_GET["search"])){
    ...
    $sql = "SELECT id, name, image, price FROM products  Where themes='hero' ORDER BY id DESC LIMIT $offset, $items_per_page";
}

$result = mysqli_query($conn, $sql);

// Get total number of rows
$total_rows = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM products Where themes='hero'"));
