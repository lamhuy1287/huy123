...
if(isset($_GET["search"])){
    $search= $_GET["search"];
    $sql = "SELECT id, name, image, price, themes FROM products WHERE name LIKE '%$search%' OR product_code LIKE '%$search%' OR themes LIKE '%$search%' LIMIT $offset, $items_per_page";
} else {
    $sql = "SELECT id, name, image, price, themes FROM products ORDER BY id DESC LIMIT $offset, $items_per_page";
}
